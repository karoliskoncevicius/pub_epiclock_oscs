...
# select only mitotic clocks
dat1 <- dat1[,c(1,19,20,9:12)]
dat2 <- dat2[,c(1,19,20,9:12)]
...
pdf("fig_s6.pdf", width = 18/2.54, height = 14/2.54, pointsize = 4)

par(mfrow=c(4,2), mar=c(1,1,2,3), oma=c(2,5,0,0), tck=-0.02, mgp=c(2.5,0.5,0), cex = 0.9)
