...
res <- col_t_paired(dat[dat$time == "16:15", 2:7], dat[dat$time == "12:45", 2:7])
...
pdf("fig_s4_d.pdf", width = 18/2.54, height = 5/2.54, pointsize = 8)
...
text(xs-0.65, 4.35, rownames(res), pos = 4, srt = 45, xpd = NA)

text(3, 1.25, "PC-based clocks")
